...
// return the existing object of Boolean type without having to create new instances
...
// evaluate if a given AST node which (in execution) value should have
